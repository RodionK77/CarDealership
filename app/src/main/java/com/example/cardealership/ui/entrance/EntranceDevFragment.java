...
public class EntranceDevFragment extends Fragment {
    Context context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View RootView = inflater.inflate(R.layout.fragment_entrance_dev, container, false);
        etPass = (EditText) RootView.findViewById(R.id.et_dev_password_enter);
        etCode = (EditText) RootView.findViewById(R.id.et_dev_code_enter);
        etEmail = (EditText) RootView.findViewById(R.id.et_dev_mail_enter);
        checkPasswordVisible(etPass);
        checkPasswordVisible(etCode);

        mAuth = FirebaseAuth.getInstance();
        btnEnter = RootView.findViewById(R.id.btn_dev_enter);
