...
public class RegistrationAdminFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        etPass = (EditText) RootView.findViewById(R.id.et_admin_password);
        etPass2 = (EditText) RootView.findViewById(R.id.et_admin_password2);
        etCode = (EditText) RootView.findViewById(R.id.et_admin_code);
        etEmail = (EditText) RootView.findViewById(R.id.et_admin_mail);
        etName = (EditText) RootView.findViewById(R.id.et_admin_name);
        etLastName = (EditText) RootView.findViewById(R.id.et_admin_lastname);
        etPhone = (EditText) RootView.findViewById(R.id.et_admin_phone);
        etBirthday = (EditText) RootView.findViewById(R.id.et_admin_date);
        checkPasswordVisible(etPass);
        checkPasswordVisible(etPass2);
        checkPasswordVisible(etCode);

        mAuth = FirebaseAuth.getInstance();
        btnRegistration = RootView.findViewById(R.id.btn_admin_registration);
                            ...
                            mAuth.createUserWithEmailAndPassword(etEmail.getText().toString(), etPass.getText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(context,"Администратор успешно зарегестрировался", Toast.LENGTH_SHORT).show();
